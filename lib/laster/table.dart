  ...
  Widget _getBodyWidget() {
    ...
    return Container(
      child: HorizontalDataTable(
        leftHandSideColumnWidth: MaxSize.width * 0.2,
    ...
    return [
      TextButton(
        ...
        child: _getTitleItemWidget(
            '暱稱' + (sortType == sortName ? (isAscending ? '↓' : '↑') : ''),
            100),
        onPressed: () {
          sortType = sortName;
            ...
            children: <Widget>[
              IconButton(
                  icon: Icon(
                      ...
                      color: user.userInfo[index].status
                          ? Colors.red
                          : Colors.green),
                  onPressed: () {
                    setState(() {
...
class User {
  ...
  void initData(int size) {
    for (int i = 0; i < size; i++) {
      userInfo.add(
          UserInfo("暱稱_$i", i % 3 == 0, '+001 9999 9999', '2019-01-01', 'N/A'));
    }
  }
